...
if __name__ == "__main__":
    ...
    plot_latency_over_time('test/results/weighted_round_robin_latency_over_time.png', ['Baseline', 'Weighted Round Robin'], baseline_results, weighted_round_robin_results)
    plot_successful_requests_over_time('test/results/weighted_round_robin_throughput.png', ['Baseline', 'Weighted Round Robin'], baseline_results, weighted_round_robin_results)
